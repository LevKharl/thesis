...
final_dataset_file = '/Users/kharlashkin/Coding/thesis/data/cleaned_final_dataset.csv'
...
special_tokens = [f'[{tag}]' for tag in selected_tags]
...
tokenizer.save_pretrained("/Users/kharlashkin/Coding/thesis/model/tokenizer")
# Save the individual components of the Mustango model
torch.save(model.vae.state_dict(),
           "/Users/kharlashkin/Coding/thesis/model/vae.pt")
torch.save(model.stft.state_dict(),
           "/Users/kharlashkin/Coding/thesis/model/stft.pt")
torch.save(model.model.state_dict(),
           "/Users/kharlashkin/Coding/thesis/model/music_diffusion_model.pt")
